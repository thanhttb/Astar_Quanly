    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark sbold uppercase">Phiếu Chi</span>
            </div>
        </div>
        <div class="portlet-body form">
            <form class="form-horizontal" role="form" action={{url('/postPayment')}} method="POST">
                ...
                <div class="form-body">
                    ...
                    <div class="col-md-12 form-group">                        
                        ...
                        <input type="text" name="student" class="form-control" placeholder="Nhập tên người nhận" id="to">
                   </div>
                    <div class="col-md-12 form-group mt-repeater">
                        <div data-repeater-list="khoanchi">
                        ...
                        <a href="javascript:;" data-repeater-create class="btn btn-info mt-repeater-add" id="add-khoan-chi">
                            <i class="fa fa-plus"></i>Thêm khoản chi</a>
                    </div>                    
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="mt-radio-list">
                                ...
                                <label class="mt-radio mt-radio-outline">
                                    <input type="radio" name="method" id="cash" value="cash" checked=""> Chi trực tiếp
                                    <span></span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="portlet light bordered">                
                            <div class="portlet-body">
                                <?php
                                    ...
                                    $r->table('payment')->where('created_at >',date('Y-m-d 00:00:00'))->where('created_at <',date('Y-m-d 23:59:59'));
                                    $r->table_name('Phiếu chi ngày hôm nay');
    ...
    jQuery(document).ready(function() {
            ...
            $('#submit').click(function(){
                for (var i = 0; i <= count; i++) {
                    ...
                    var description = "[name = 'khoanchi["+i+"][note]']";
                    var amount = "[name = 'khoanchi["+i+"][amount]']";
