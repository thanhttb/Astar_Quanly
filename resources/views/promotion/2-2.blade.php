		   ...
		   <div class="content">
		        <div class="table">
		            <div class="table-cell">
		                ...
		                <p class="text" id="img{{$i}}">Chú Thích Hình Ảnh</p>
		            </div>
		            <?php $i++; ?>
		        </div>
		    </div>
...
Convert to image
	...
	<script type="text/javascript">
		...
		$('#img2').click(edit_text(2));
		$('#img1').click(edit_text(1));
		$('#img3').click(edit_text(3));
		$('#img4').click(edit_text(4));
