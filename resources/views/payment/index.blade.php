	...
	<body style="font-size: 20px;">
		...
		<article>
			...
			<address contenteditable>
				<p>Người nhận: <br>{{$newPayment->account}}</p>
			</address>
			<table class="meta">
				<tr>
					<th><span>Phiếu thu #</span></th>
					<td><span contenteditable>{{$newPayment->id}}</span></td>
				</tr>
				<tr>
					<th><span>Ngày</span></th>
					<td><span contenteditable id="date">{{date('d/m/y',strtotime($newPayment->created_at))}}</span></td>
				</tr>
				<tr>
					<th><span>Số tiền</span></th>
					<td><span id="prefix" ></span><span>{{asVnd($newPayment->amount)}}</span></td>
				</tr>
			</table>
			<table class="inventory">
				...
				<tbody>
					@foreach($request->khoanchi as $value)
						<tr>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix></span><span>{{asVnd($newPayment->amount)}}</span></td>
				</tr>
			...
			<table >
				<tr>
					...
					<td><span data-prefix></span><span contenteditable>{{convert_number_to_words($newPayment->amount)}} đồng</span></td>
				</tr>
