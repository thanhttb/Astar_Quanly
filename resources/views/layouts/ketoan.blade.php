...
<html lang="en" ng-app="astar">
    ...
    <head>
        <meta charset="utf-8" />
        <title>A-Star Education | Management</title>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="{{route('profile')}}">
                        <img src="{{ asset('assets/layouts/layout4/img/astar.png') }}" alt="logo" class="logo-default" style="margin-top: 18px;" height="45px" /> </a>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <img alt="" class="img-circle" src="{{ asset('public/avatar/'.Auth::user()->avatar)}}" /> </a>
        ...
        <!-- BEGIN CONTAINER -->
        <div class="page-container" style="background: #e9ecf3;">
            <!-- BEGIN SIDEBAR -->
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu" data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item" id="account-0">
                            <a href="javascript:;" class="nav-link nav-toggle">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item" id="account-1">
                                    <a href="{{ url('/ketoan/listAccount') }}">Danh sách tổng</a>
                                </li>
                                <li class="nav-item" id="account-2">
                                    <a href="{{ url ('/ketoan/listGroup') }}">Quản lý nhóm</a>
                                </li>                                
                            </ul>
                        <li class="nav-item" id="transaction-0">
                            <a href="javascript:;" class="nav-link nav-toggle">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item" id="transaction-1">
                                    <a href="{{ url('/ketoan/listAllTransaction') }}">Danh sách giao dịch</a>
                                </li>  
                       ...
                       <!--  <li class="nav-item">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">PHIẾU THU - CHI</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="{{ url('/listTeacher') }}">Thêm phiếu chi</a>
                                </li>
                                <li class="nav-item  ">
                                    <a href="{{ url('/listTutor') }}">Thêm phiếu thu</a>
                                </li>  
                                <li class="nav-item  ">
                                    <a href="{{ url('/listUser') }}">Danh sách phiếu thu - chi</a>
                                </li>                             
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">QUẢN LÝ CÔNG NỢ</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                            ...
                                            <ul class="theme-settings">
                                                ...
                                                <li> Header
                                                    <select class="page-header-option form-control input-small input-sm">
                                                        <option value="default" selected="selected">Fixed</option>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2017 &copy; Astar Education Center
                <a target="_blank" href="http://astar.edu.vn">Website</a> &nbsp;|&nbsp;
            </div>
