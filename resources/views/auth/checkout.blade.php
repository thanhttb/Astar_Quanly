    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-red-sunglo">
                <i class="fa fa-stop font-red-sunglo"></i>
                <span class="caption-subject bold uppercase">Check out</span>
            </div>
            <!-- <div class="actions">
                <div class="btn-group">
        ...
        <div class="portlet-body form">
            <form role="form" method="POST" action="{{route('postCheckout')}}">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="textarea" name="note" class="form-control input-circle-right" placeholder="Hãy nói"> </div>
                    </div>
                    <div class="form-group">
                        <div class="mt-checkbox-list">
                            <label class="mt-checkbox"> Bạn đã sẵn sàng về nhà ?
