        ...
        <div class="profile-sidebar">
            ...
            <div class="portlet light profile-sidebar-portlet bordered">
                ...
                <div class="profile-userpic">
                    <img src="public/avatar/{{Auth::user()->avatar}}" class="img-responsive" alt="" style="max-height: 150px;"> </div>
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
                                ...
                                <div class="tab-pane" id="tab_1_3">
                                    ...
                                    <form action="{{route('change_password')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="oldPassword" /> </div>
                                        <div class="form-group">
                                            <label class="control-label">New Password</label>
                                            <input type="password" class="form-control" name="newPassword" /> </div>
                                        <div class="form-group">
                                            <label class="control-label">Re-type New Password</label>
                                            <input type="password" class="form-control" name="reTypePassword" /> </div>
                                        <div class="margin-top-10">
