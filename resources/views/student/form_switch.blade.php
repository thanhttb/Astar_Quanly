    ...
    <div class="portlet box red-sunglo">
        <div class="portlet-title">
            <div class="caption font-blue-sunglo">
                ...
                <span class="caption-subject bold uppercase">Chuyển lớp</span>
            </div>

        </div>
        <div class="portlet-body form">
            <form role="form" method="POST" action="{{route('switchClass')}}">
                <div class="form-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control input-circle-right" name=""> </div>
                        </div>
                        <div class="form-group col-md-3">
                            <label>Lý do xin chuyển</label>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control input-circle-right" name="to">
                                @foreach($allClasses as $class)
                                    <option class="form-control input-circle-right  input-circle-left" value="{{$class->id}}">{{$class->name}}</option>
                                @endforeach
                            </select>
                        </div>
