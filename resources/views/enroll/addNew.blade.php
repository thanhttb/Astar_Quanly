    ...
    <div class="container-fluid">
        <div class="row">
            ...
            $addnew->label(array(
                    ...
                    't2.subject' => 'Môn học',
                    't2.class' => 'Khối lớp',
                    't2.appointment' => 'Hẹn lịch KT đầu vào'
                )); 
            
            $addnew->validation_required(array('t1.firstName','t1.lastName','phone','t2.subject','t2.class'));
            $addnew->after_insert('add_enroll');
            $addnew->hide_button(array('save_return','return'));
